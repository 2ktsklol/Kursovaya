...
namespace Kursovaya
{
    public partial class FormRegist : Form
    {
        public FormRegist()
        {
            ...
            textBoxPasswordConfirmation.ShortcutsEnabled = false;
        }
        ...
        {
            MessageBox.Show("Данное приложение позволяет найти номер телефона интересующего абонента по его полному имени и фамилии. Для получения доступа к функционалу необходимо авторизоваться.", "Возможности приложения", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
    }
}
